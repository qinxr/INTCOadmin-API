...
//二次配料信息接口
//获取展示列表信息
Route::get('pladminSec/getPlInfos/{factory}','PvcplSecController@getPlInfos');
//增
Route::post('pladminSec/addPlInfo','PvcplSecController@addPlInfo');
//查指定id
Route::post('pladminSec/getPlAsId/{id}','PvcplSecController@getPlAsId');
//改
Route::post('pladminSec/editpl/{id}','PvcplSecController@editpl');
//获取配方表名称信息
//Route::get('pladminSec/getPlnames','PvcplController@getPlnames');
//查指定名称
//Route::post('pladminSec/getPlAsName/{name}','PvcplController@getPlAsName');
